...
import picture from "../../utils/PlantScoutScreenshot.png";
    ...
    return (
        <section style={styles.containerStyle} className="container">
            <p style={styles.containerFont}>
                Here you can check out some of the projects I've made throughout the journey of honing my skills as a full-stack developer! Feel free to check out the repos (and, if you want, fork them), live links, and video demos.
            ...
            <img className="card-img" src={picture}></img>
          ...
          <div className="card">
            <div className="card-body">
              ...
              {/* <img className="card-img" src={picture1}></img> */}
          ...
          <div className="card">
            <div className="card-body">
              ...
              <img className="card-img" src="/utils/BudgetTrackerScreenshot.png"></img>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <img className="card-img" src="/utils/NotetakerappScreenshot.png"></img>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <img className="card-img" src="./utils/TPGscreengrab11.png/"></img>
              <h6 className="card-subtitle mb-2 text-muted"><i>Render your work team from the command line.</i></h6>
              <p className="card-text">Team Profile Generator is a CLI application that renders a smooth and clean webpage from the command line using Node.js.</p>
              <a href="https://github.com/preussenfahrer/notetakerapp" target="_blank" className="card-link">GitHub Repo</a>
              <a href="https://drive.google.com/file/d/1oCOtYvZiA653tQ28nJqmp-Obo0222_qJ/view" target="_blank" className="card-link">Video Demo</a>
            </div>
          </div>
