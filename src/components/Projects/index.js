...
function Projects() {
  ...
  <div className="card-body">
    ...
    <a href="https://github.com/preussenfahrer/plant-scout" className="card-link">GitHub Repo</a>
    <a href="https://karajsch.github.io/plant-scout/" className="card-link">Deployed Application</a>
  </div>
</div>
<div className="card">
  <div className="card-body">
    ...
    <a href="https://github.com/preussenfahrer/shop_n_chef" className="card-link">GitHub Repo</a>
    <a href="https://shop-n-chef.herokuapp.com/" className="card-link">Deployed Application</a>
  </div>
</div>
<div className="card">
  <div className="card-body">
    ...
    <a href="https://github.com/preussenfahrer/Budget-Tracker" className="card-link">GitHub Repo</a>
    <a href="#https://morning-garden-03578.herokuapp.com/" className="card-link">Deployed Application</a>
  </div>
</div>
<div className="card">
  <div className="card-body">
    ...
    <a href="https://github.com/preussenfahrer/EmployeeTracker" className="card-link">GitHub Repo</a>
    <a href="https://drive.google.com/file/d/1N5VLuZFXxTiVJvBSZp0YQRpF8TYUGmy_/view" className="card-link">Video Demo</a>
  </div>
</div>
<div className="card">
  <div className="card-body">
    ...
    <a href="https://github.com/preussenfahrer/notetakerapp" className="card-link">GitHub Repo</a>
    <a href="https://drive.google.com/file/d/1oCOtYvZiA653tQ28nJqmp-Obo0222_qJ/view" className="card-link">Video Demo</a>
  </div>
</div>
