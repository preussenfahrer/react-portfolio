...
function Container() {
    return (
        <section className="container-bgr">
            ...
            <Link to ={CV} className="px-2" target="_blank" download>R&eacute;sum&eacute;</Link>
            <Link to className="px-2" target="_blank" href="mailto:gregjleighton@gmail.com">Email</Link>
            <Link className="px-2" target="_blank" href="https://github.com/preussenfahrer">GitHub</Link>
            <Link className="px-2" target="_blank" href="https://www.linkedin.com/in/greg-leighton-59b411142/">LinkedIn</Link>
            </div>
        </section>
        </section>
